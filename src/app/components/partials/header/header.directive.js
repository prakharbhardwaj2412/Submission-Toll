(function() {
    ...
    function minotaurHeader($window) {
        ...
        /** @ngInject */
        function HeaderController($http, CheckSession, BaseUrl, BaseUrl_Files, $cookies, $log, $scope, $rootScope, ResponseCheck, $state) {
...
console.log(JSON.parse(localStorage.getItem("data")));
            // if (JSON.parse(localStorage.getItem("data")) != null || JSON.parse(localStorage.getItem("data")) != undefined || JSON.parse(localStorage.getItem("data")) != "") {
            ...
            //   }
                ...
                vm.onTextClick = function()
                {
                    if(vm.toggle == 0)
                    {
                        ...
                        document.getElementById('profile_view').setAttribute("aria-expanded", true);
                        // document.getElementById('ui').click();
                        vm.toggle = 1;
                        // document.getElementById('ui').classList.add("open")
                        ...
                        document.getElementById('profile_view').setAttribute("aria-expanded", false);
                        document.getElementById('ui').click();
                        vm.toggle = 0;
                    }
